...
import { devDeckSize, handSize as handSizeOf, publicVictoryPoints, unplayedDevCount as unplayedDevCountOf, victoryPoints } from '@colonist/shared';
import { longestRoadLength } from '@colonist/shared';
import type { GameState, Player } from '@colonist/shared';
